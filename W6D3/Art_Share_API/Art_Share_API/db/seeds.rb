...
comment1 = Comment.create!(body: 'great!', commenter_id: user1.id, artwork_id: artwork1.id)
comment2 = Comment.create!(body: 'another great one', commenter_id: user2.id, artwork_id: artwork2.id)
